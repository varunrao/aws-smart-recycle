...
const receiverTopicName = "test123";
const publisherTopicName = "publish123"
const threshold = 20;
            ...
            <td>
              <ButtonToolbar className="operator-toolbar">
                <Button variant="outline-success" className="operators" onClick={() => {
                  const operator = 1;
                  PubSub.publish(publisherTopicName, { "operation": operator });
                  classification = "success";
...
export default withAuthenticator(Clean, true);
